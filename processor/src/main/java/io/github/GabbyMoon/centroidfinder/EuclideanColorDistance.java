/**
 * A class that implements the ColorDistanceFinder interface to calculate the Euclidean distance between two colors.
 * Each color is represented as a 24-bit integer in the form 0xRRGGBB, where RR is the red component, GG is the green component, and BB is the blue component, each ranging from 0 to 255.
 * The Euclidean color distance is calculated by treating each color as a point in 3D space (red, green, blue) and applying the Euclidean distance formula:
...
public class EuclideanColorDistance implements ColorDistanceFinder {
    ...
    public double distance(int colorA, int colorB) {
        // isolate red and shifting 16 bits
